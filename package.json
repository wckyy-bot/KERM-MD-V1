{
  "name": "KERM-MD-V1",
  "version": "1.0.0",
  "description": "A WhatsApp bot created using Node.js bro",
  "main": "index.js",
  "scripts": {
    "start": "pm2 start index.js --deep-monitoring --attach --name KERM-MD-V1",
    "stop": "pm2 stop KERM-MD-V1",
    "restart": "pm2 restart KERM-MD-V1"
  },
  "dependencies": {
